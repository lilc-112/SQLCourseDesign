...
import com.example.sqlcourse_design.login.data.LoginRepository;
import com.example.sqlcourse_design.login.data.Result;
    ...
    public void login(String username, String password) {
        ...
        if (result instanceof Result.Success) {
            ...
            loginResult.setValue(new LoginResult(
                    new LoggedInUserView(data.getDisplayName())));
        } else if (result instanceof Result.Failed) {
            loginResult.setValue(new LoginResult(
                    ((Result.Failed<String>) result).getData()));
        } else {
